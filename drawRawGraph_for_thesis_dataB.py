...
data.append(d)
"""
d = ReadData("./bombykol_200ms/15d29031.atf")
t = "10ng"
l = "A"
label.append(l)
title.append(t)
...
d = ReadData("./bombykol_200ms/15d29032.atf")
t = "100ng"
l = "B"
label.append(l)
title.append(t)
...
d = ReadData("./bombykol_200ms/15d29033.atf")
t = "1000ng"
l = "C"
label.append(l)
title.append(t)
...
d = ReadData("./bombykol_200ms/15d29034.atf")
t = "2000ng"
l = "D"
label.append(l)
title.append(t)
...
d = ReadData("./bombykol_200ms/15d29035.atf")
t = "5000ng"
l = "E"
label.append(l)
title.append(t)
...
d = ReadData("./bombykol_200ms/15d29036.atf")
t = "10000ng"
l = "F"
label.append(l)
title.append(t)
...
for i in range(6):
    plt.subplot(3,2,i+1)
    plt.plot(data[i].time[int(2.5/data[i].dt):],data[i].volt[int(2.5/data[i].dt):],'k',linewidth=0.5,color="#3d3d3d")
    #plt.plot(time,voltage,'r')
    fig.patch.set_alpha(0.0)
    plt.axis('off')
    #plt.ylim(-1.5,2.0)
    ...
    if(i==4):
        ...
        plt.plot([2.1,2.1],[-0.6,-0.1],'k',linewidth=3)
        plt.plot([2.1,3.1],[-0.6,-0.6],'k',linewidth=3)
        plt.text(-0.5,-0.5,"0.5mV",fontsize=15)
        plt.text(2.0,-0.8,"1s",fontsize=15)
    font = font0.copy()
    font.set_weight('bold')
    font.set_size(20)
    plt.text(1.5,0.5,label[i],fontproperties=font)
    plt.title(title[i])
    plt.plot(data[i].dt*np.array(data[i].stim_timing[0]),[-0.6,-0.6],'k',linewidth=4)
plt.savefig("RawdataGraph_dataB.png")
